...
import * as ActionTypeCountry from '../Constants/CountryConst'
import { handleUsrSignin,handleUsrSignout,handleUsrSignup } from "./UsrMidle";
import { handleAddCountry, handleDelCountry, handleEditCountry, handleGetCountry, handleGetOneCountry } from "./CounteryMidle";
function* watchAll(){
    yield all([
